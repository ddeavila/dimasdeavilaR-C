...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("R_CPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT u FROM Utencilio u");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<unicordoba.registro.basededatos.entity.Utencilio> toRemove = new ArrayList<unicordoba.registro.basededatos.entity.Utencilio>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            unicordoba.registro.basededatos.entity.Utencilio u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        unicordoba.registro.basededatos.entity.Utencilio u = new unicordoba.registro.basededatos.entity.Utencilio();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<unicordoba.registro.basededatos.entity.Utencilio> merged = new ArrayList<unicordoba.registro.basededatos.entity.Utencilio>(list.size());
            for (unicordoba.registro.basededatos.entity.Utencilio u : list) {
    ...
    private java.util.List<unicordoba.registro.basededatos.entity.Utencilio> list;
